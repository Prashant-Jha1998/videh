...
> = {
  classic: { title: "Classic", subtitle: "Videh greens & basics" },
  amoled: { title: "AMOLED Black", subtitle: "Pure black, battery friendly" },
  neon: { title: "Dark Neon", subtitle: "Glow accents on dark" },
  gold: { title: "Gold", subtitle: "Premium metallic look" },
  gradient: { title: "Gradients", subtitle: "Smooth color blends" },
  festival: { title: "Festival", subtitle: "Diwali, Holi & celebrations" },
  custom: { title: "Custom", subtitle: "Your bubble picks" },
};
...
function fromAppTheme(opt: AppThemeOption): ThemeAppearance {
  ...
  const pack = override?.pack ?? (opt.kind === "gradient" ? "gradient" : "classic");
