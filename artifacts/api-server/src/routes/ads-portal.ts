  ...
  try {
    ...
    res.json({
      ...
      pricing: {
        ...
        vibeCpmInr: ads.vibeCpmInr,
        vibeCpcInr: ads.vibeCpcInr,
        vibeCpiInr: ads.vibeCpiInr,
        vibeCpvInr: ads.vibeCpvInr,
        ...
        objectives: [
          ...
          { id: "vibe_reach", label: "Vibe reach (premium vertical)", bidModel: "cpv", defaultBid: ads.vibeCpvInr },
        ],
        ...
        placements: [
          ...
          { id: "vibe_feed", label: "Vibe vertical feed (premium)" },
          { id: "shorts_feed", label: "Shorts vertical feed (legacy)" },
