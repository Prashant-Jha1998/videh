  ...
  return (
    <section id="portal" className="py-16 px-4 bg-white border-t border-gray-100">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-2xl font-bold text-[#14131F] mb-2 flex items-center gap-2">
          <MessageSquare className="h-6 w-6 text-[#5B4FE8]" />
          ...
          <div className="mt-8 rounded-2xl border border-gray-200 p-6 space-y-6">
            <div>
              <p className="text-sm text-[#667781]">
                <strong className="text-[#14131F]">{data.lead.company_name}</strong> ·{" "}
            ...
            {data.account ? (
              <div className="rounded-xl bg-[#f0f2f5] p-4 text-sm">
                <p className="font-semibold text-[#14131F] mb-2">API credentials</p>
                <p>
                  Key ID: <code className="bg-white px-1 rounded">{data.account.api_key_id}</code>
                  <button
                    type="button"
                    className="ml-2 text-[#5B4FE8]"
              ...
              <div className="rounded-xl bg-[#f0f2f5] p-4 text-sm">
                <p className="font-semibold text-[#14131F] mb-2">Channel IDs (awaiting API approval)</p>
                <p>
                    ...
                    <li key={t.id} className="rounded-xl border border-gray-100 p-4 text-sm">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        {t.status === "approved" || t.approved ? (
                          <CheckCircle2 className="h-5 w-5 text-[#5B4FE8] shrink-0" />
                        ) : (
