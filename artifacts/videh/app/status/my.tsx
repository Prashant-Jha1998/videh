...
const styles = StyleSheet.create({
  ...
  textThumb: { alignItems: "center", justifyContent: "center", backgroundColor: "#059669" },
  ...
  priceCard: { backgroundColor: "#05966922", borderWidth: 1, borderColor: "#05966955", borderRadius: 16, padding: 14 },
