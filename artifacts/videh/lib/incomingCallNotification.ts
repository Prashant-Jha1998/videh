  ...
  await Notifications.scheduleNotificationAsync({
    ...
    content: {
      ...
      data: {
        ...
        callerId: call.callerId != null ? String(call.callerId) : "",
        callerName: call.callerName,
        kind: "call",
        notificationKind: "incoming_call",
        deepLink: `videh://call/${call.chatId}?callId=${encodeURIComponent(call.callId)}&incoming=1&ringing=1&type=${call.type}&name=${encodeURIComponent(call.callerName)}&channel=${encodeURIComponent(call.channel)}&callerId=${call.callerId ?? ""}`,
      },
    },
    trigger: null,
