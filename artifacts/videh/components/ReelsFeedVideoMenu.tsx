...
export type FeedVideoMenuAction =
  | "play_next"
  | "watch_later"
  | "save_playlist"
  | "download"
...
const MENU_ITEMS: MenuItem[] = [
  ...
  { id: "not_interested", label: "Not interested", icon: "remove-circle-outline" },
  { id: "dont_recommend_channel", label: "Don't recommend channel", icon: "person-remove-outline" },
...
type Props = {
  ...
  videoTitle?: string;
  onClose: () => void;
  onAction: (action: FeedVideoMenuAction) => void;
};

export function ReelsFeedVideoMenu({ visible, videoTitle, onClose, onAction }: Props) {
